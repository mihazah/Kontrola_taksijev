...
//$html = "";
  $html= "<table>";
    $html.= "<tr>";
      $html.= "<td colspan=4><h1>Zapisnik o vgradnji in nastavitvi  taksimetra s serijsko st: ".$taksimeter['Serijska_st']."</h1></td>";
    $html.= "</tr>";
    //VOZILO
    $html.= "<tr>";
      ...
      $html.= "<td colspan=4>";
        $html.= "<table border=1 width='100%'>";
          ...
          for($i=0; $i<$tarife->num_rows; $i++){ //gre do konca stevila vrstic oz. kolikor je tarif v bazi
            ...
            $html.= "<tr>";
            $html.= "<td>Tarifa ". ($i+1)."</td>";
            $html.= "<td>".$tarifa['Vrsta']."</td>";
            $html.= "<td>".$tarifa['Startnina']."</td>";
            $html.= "<td>".$tarifa['Voznja_km']."</td>";
            $html.= "<td>".$tarifa['Cakalna_ura']."</td>";
            $html.= "<td>".$tarifa['Startnina_nocna']."</td>";
            $html.= "<td>".$tarifa['Voznja_km_nocna']."</td>";
            $html.= "<td>".$tarifa['Cakalna_ura_nocna']."</td>";
            $html.= "</tr>";
          }
        $html.= "</table>";
      $html.= "</td>";
